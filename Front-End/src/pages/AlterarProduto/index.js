                            ...
                            <div className="variacoes">
                                ...
                                {variacoes.map((variacao, index) => (
                                    <div key={index} className="variacao">
                                        ...
                                        <input className='variacaoTexto' id={`quantidade-${index}`} type="text" name="quantidade" value={variacao.quantidade} placeholder="Quantidade" onChange={(event) => { const inputValue = event.target.value.replace(/[^0-9.]/g, ''); const sanitizedValue = inputValue.replace(/^-/, ''); handleVariacaoChange(index, { target: { name: 'quantidade', value: sanitizedValue } }); }} />
                                        {variacoes.length > 1 && (
