...
export default function AlterarProduto() {
    ...
    async function buscarProdutoPorproduto_id(produto_id) {
        try {
            ...
            const r = await fetch(`http://localhost:8080/produto/${produto_id}`, {
                method: 'GET',
                headers: {
            ...
            const { item, imagens, variacao } = r.data;
            ...
            setproduto_id(produto_idRecebido);
    ...
    async function alterar(e) {
        try {
            ...
            const r = await fetch(`http://localhost:8080/produto?produtoId=${produto_idRecebido}`, {
                method: 'PUT',
                headers: {
                    'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJSb2xlIjoiVVNVQVJJTyIsIklzc3VlciI6ImVjb21tZXJjZSIsIlVzZXJuYW1lIjoidGVzdGUiLCJleHAiOjE2OTk5MDk5OTcsImlhdCI6MTY5OTkwOTk5N30.Ua4Hk1F5PulvwqlsZkja48PMO0NTbkUXp_xfYELka74'
                },
                ...
                <div className="mainConteudo">
                    ...
                    <div className="formulario">
                        <form>
                            ...
                            <input id="produto_id" type="text" name="produto_id" value={produto_id} onChange={(e) => setproduto_id(e.target.value)} disabled></input>
