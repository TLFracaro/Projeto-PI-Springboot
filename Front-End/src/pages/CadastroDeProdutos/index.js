...
export default function CadastroDeProdutos() {
    ...
    const updateImagens = (selectedFiles) => {
        const newImagens = [...imagens];
        for (let i = 0; i < selectedFiles.length; i++) {
            const file = selectedFiles[i];

            if (!newImagens.some((img) => img.name === file.name)) {
                newImagens.push(file);
            }
        }
                ...
                <div className="mainConteudo">
                    ...
                    <div className="formulario">
                        <form>
                            ...
                            <input id="locEstoque" type="text" name="locEstoque" value={locEstoque} onChange={(e) => setLocEstoque(e.target.value === "" ? null : e.target.value)}></input>
